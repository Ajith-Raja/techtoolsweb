...
export default function SitemapVisualizer() {
  ...
  }, [sitemapData, visualizationMode, canvasSize]);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // For demonstration, generate a random sitemap structure
    // In a real implementation, this would fetch and parse the actual sitemap
    setTimeout(() => {
      try {
        let sitemapRoot: SitemapNode;
        
        if (inputMethod === "text") {
          sitemapRoot = parseXmlSitemap(textInput);
        } else {
          sitemapRoot = generateRandomSitemap();
        }
        
        setSitemapData(sitemapRoot);
        toast({
        ...
        toast({
          ...
          description: "Could not process the sitemap data",
          variant: "destructive",
        });
      } finally {
        setIsLoading(false);
